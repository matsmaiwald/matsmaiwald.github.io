...
Having removed any influences of measurement scales, we can go on to calculate the variance covariance matrix of our demeaned data as $$C_X = \frac{1}{N-1}  XX^T $$, where $$N$$ is the number of observations.
